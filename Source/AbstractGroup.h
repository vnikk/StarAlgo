...
struct unitGroup_t
{
    ...
    : unitTypeId(unit), numUnits(size), regionId(region), orderId(order), targetRegionId(targetRegion), endFrame(0), startFrame(initFrame), HP(_HP)
    {}
    ...
    : unitTypeId(unit), numUnits(size), regionId(region), orderId(order), targetRegionId(targetRegion), endFrame(frame), startFrame(initFrame), HP(_HP)
    {}
};
